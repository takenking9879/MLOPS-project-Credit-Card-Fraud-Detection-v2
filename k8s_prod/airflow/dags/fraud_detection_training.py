...
class FraudDetectionTraining:
    ...
    def __init__(self, config_path='dags/repo/k8s_prod/airflow/dags/config_k8s.yaml'):
        ...
        # Endpoint opcional:
        # - MinIO: MLFLOW_S3_ENDPOINT_URL='http://my-minio:9000'
        # - S3 real: MLFLOW_S3_ENDPOINT_URL='' (vacío)
        endpoint_url = self.config.get('mlflow', {}).get('s3_endpoint_url') or None
        if endpoint_url == "":
            endpoint_url = None
        ...
        if endpoint_url:
            os.environ['AWS_S3_ENDPOINT_URL'] = endpoint_url
    ...
    def _load_config(self, config_path:str) -> Dict:
        try:
            ...
            # Reemplaza placeholders ${VAR} si están definidos
            for key in [
                ...
                if key in os.environ:
                    raw_config = raw_config.replace(f"${{{key}}}", os.environ.get(key, ""))
    ...
    def _validate_environment(self):
        try:
            ...
            if os.environ.get('MLFLOW_S3_ENDPOINT_URL'):
                ...
                logger.info('Skipping MinIO endpoint check (S3 real / no endpoint configured).')
        except Exception as e:
    ...
    def train_model(self):
        try:
            ...
            with mlflow.start_run():
                ...
                model_path = self.config.get('model', {}).get('path', '../../models/fraud_detection_model.pkl')
