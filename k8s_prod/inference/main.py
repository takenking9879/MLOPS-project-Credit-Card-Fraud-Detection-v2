...
class FraudDetectionInference:
    ...
    def __init__(self, config_path='/app/repo/k8s_prod/airflow/dags/config_k8s.yaml'):
    ...
    def read_from_kafka(self):
        logger.info("Reading data from Kafka topic %s", os.environ.get("KAFKA_TOPIC", "transactions"))
    ...
    def run_inference(self):
        ...
        (fraud_predictions.selectExpr(
         ...
         .option("checkpointLocation", "/mnt/checkpoints/fraud_predictions")  # For fault tolerance and recovery
         .outputMode("update")  # Only write updated records
         .start()
         .awaitTermination())  # Keep the streaming context alive

if __name__ == "__main__":
    inference = FraudDetectionInference('/app/repo/k8s_prod/airflow/dags/config_k8s.yaml')
